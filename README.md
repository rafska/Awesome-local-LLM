...
- <img src="https://img.shields.io/github/stars/DrDroidLab/open-index?style=social" height="17" align="texttop"/> [Open Index](https://github.com/DrDroidLab/open-index) - local structured context graphs with hybrid search and read/write MCP access for domain-specific agents
