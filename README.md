...
- <img src="https://img.shields.io/github/stars/gumieri/nenya?style=social" height="17" align="texttop"/> [nenya](https://github.com/gumieri/nenya) - a zero-dependency AI gateway in Go that redacts secrets, routes across cloud and local (Ollama) providers, and injects MCP tools for coding agents
