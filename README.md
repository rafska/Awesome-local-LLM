...
- <img src="https://img.shields.io/github/stars/futuregene/future-os?style=social" height="17" align="texttop"/> [future-os](https://github.com/futuregene/future-os) - one AI agent everywhere: a single Rust backend drives terminal UI, desktop, mobile, CLI, and IM bots with the same sessions, memory, and skills; approval-gated tools and 3,800+ models
