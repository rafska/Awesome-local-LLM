...
- <img src="https://img.shields.io/github/stars/sim186/AmicoScript?style=social" height="17" align="texttop"/> [AmicoScript](https://github.com/sim186/AmicoScript) - a local audio and video transcription app (Whisper + diarization) with summaries, action items and translations generated by a local LLM through the Ollama API
