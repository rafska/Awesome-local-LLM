...
- <img src="https://img.shields.io/github/stars/shyringo/qwen3.8-flash-next-in-c?style=social" height="17" align="texttop"/> [qwen3.8-flash-next-in-c](https://github.com/shyringo/qwen3.8-flash-next-in-c) - run the strongest model under 200B on a single laptop CPU with native C and near-10 token/s exact batch throughput
