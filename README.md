...
- <img src="https://img.shields.io/github/stars/noqt/Lumi-Eggcracker?style=social" height="17" align="texttop"/> [Lumi Eggcracker](https://github.com/noqt/Lumi-Eggcracker) - a native Linux cgroup-v2 public alpha that kills complete, unapproved matches to its two published qualified local-AI profiles; it is a kill switch, not a sandbox
